...
tools: [read, search, edit, execute, todo, agent, web, mcp_figma_whoami, mcp_figma_get_metadata, mcp_figma_get_variable_defs, mcp_figma_search_design_system, mcp_figma_use_figma]
handoffs:
  - label: "Ajustar plan funcional"
    agent: product-discovery
    prompt: "El usuario necesita ajustar el plan funcional antes de seguir con la implementacion."
  - label: "Ajustar modelo de datos"
    agent: data-model
    prompt: "El usuario necesita ajustar el modelo de datos antes de seguir con la implementacion."
  - label: "Ver o retomar lineas de trabajo"
    agent: lineas-trabajo
    prompt: "El usuario quiere consultar sus lineas de trabajo, ver puntos de guardado o retomar desde un punto anterior."
  - label: "Preparar entorno o repositorio"
    agent: setup
    prompt: "Hay un problema de entorno, repositorio o lineas base que impide implementar de forma segura."
argument-hint: "Indica el modulo que quieres implementar o la ruta del plan funcional."
---
