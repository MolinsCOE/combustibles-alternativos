...
tools: [read, search, edit, mcp_figma_whoami, mcp_figma_get_metadata, mcp_figma_get_variable_defs, mcp_figma_search_design_system, mcp_figma_use_figma]
handoffs:
  - label: "Generar modelo de datos"
    agent: data-model
    prompt: "El usuario ha validado el plan funcional y quiere generar el modelo de datos."
argument-hint: "Describe la idea en una o dos frases, el problema que quieres resolver y cualquier contexto de negocio que ya conozcas."
user-invocable: true
---
