...
model: inherit
---
<!-- AUTO-GENERATED from .shared_ai/agents/data-model.md — DO NOT EDIT. Run: pnpm sync-ai -->
...
- **implementacion** — Implementar modulo
  _Motivo_: El usuario ha validado el modelo de datos y quiere implementar el modulo.
- **product-discovery** — Ajustar plan funcional
  _Motivo_: El plan funcional tiene lagunas o contradicciones que necesitan resolverse antes de modelar.
