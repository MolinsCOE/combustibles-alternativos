...
---
<!-- AUTO-GENERATED from .shared_ai/instructions/backend.md — DO NOT EDIT. Run: pnpm sync-ai -->
...
- Toda subclase **concreta** de `DomainError` usada en respuestas HTTP debe declarar `readonly httpStatus: number` inicializado en el constructor. Nunca dejar `httpStatus` abstracto ni sin valor cuando el middleware lo consume: si falta, el middleware asigna 500 en silencio y se pierde el código HTTP correcto.
